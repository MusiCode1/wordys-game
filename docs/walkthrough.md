...
*   **גדלים מותאמים (Tuned Sizes)**: המעבר לשימוש ב-Classes מדוייקים (`w-20` במובייל) המבטיחים ש-4 כרטיסים ייכנסו בשורה אחת במסך סטנדרטי (360px), וגדלים גדולים יותר (`w-32`) בדסקטופ.
*   **לוגיקת פריסה**: המעבר לתצוגה אופקית (תמונה לצד מילה) כעת מושפע ישירות מגובה המסך (`max-h-[600px]`) - מה שמזהה מצבים כמו מקלדת פתוחה ומקטין את התמונה בהתאם.
